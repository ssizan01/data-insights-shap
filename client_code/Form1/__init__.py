...
class Form1(Form1Template):
  ...
  def submit_button_for_processing_click(self, **event_args):
      ...
      plot_media, content = anvil.server.call('train_and_get_shap', self.target_variable_picker.selected_value, self.class_picker.selected_value)
      self.shap_summary_displayer.source = plot_media
      self.llm_output.text = content
